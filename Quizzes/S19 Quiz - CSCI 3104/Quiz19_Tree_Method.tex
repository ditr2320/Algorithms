...
\begin{proof}[Answer] $  $\\
\includegraphics[width = 75mm]{tree.png} \\
At level $i$, the work that a single node does is: 
\begin{align*}
    &= 2\frac{n}{5^i}
\end{align*}
...
\begin{align*}
    &= 2\frac{n}{5^i} \cdot 5^i \\
    &= 2n
\end{align*}
We hit a base case when: 
\begin{align*}
    \frac{n}{5^k} &< 5 \\
    n &< 5^{k+1} \\
    log_5n &< k+1 \\
    log_5n -1 &< k
\end{align*}
Therefore, this tree has $k = [log_5n -1]$ \\
Total work performed: 
\begin{align*}
T(n) &= \sum_{i=0}^{log_5(n)-1} 2n \\
&= (log_5(n)-1) \cdot 2n \\
&= (2n \cdot log_5(n)-2n) \\
& \in \Theta(nlog(n))
\end{align*}
